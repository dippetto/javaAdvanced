...
public class Main {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [The fruits in a not ordered way]
        ...
        //2b. What will this output? [Still "randomised" plus the ones we added earlier]
        System.out.println(fruitsSet);
    }
...
/*Questo funziona solo se parte da 10
...
Questo funziona solo se poniamo nella condizione l'uguaglianza al massimo o al minimo possibile*/
        ...
        //Nested for each loop per comparare i due set
        for (Integer a : setA) {
            if (setB.contains(a)) {
